...
Route::group(['middleware' => ['web', 'auth', 'peran']], function () {
    ...
    Route::prefix('keluarga-penduduk')->group(function () {
        ...
        Route::get('/pecah-kartu-keluarga/{id}', 'PendudukController@pecahKartuKeluarga')->name('penduduk.keluarga.pecah_kartu_keluarga');
        Route::post('/action/pecah-kartu-keluarga', 'PendudukController@actionpecahKartuKeluarga')->name('penduduk.keluarga.pecah_kartu_keluarga.action');
